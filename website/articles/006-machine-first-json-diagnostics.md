...
> [language/spec/cli-json.md](REPO_ROOT/language/spec/cli-json.md),
> [language/spec/cli-json.schema.json](REPO_ROOT/language/spec/cli-json.schema.json),
> and
> [language/docs/TESTING_JSON_SCHEMA.md](REPO_ROOT/language/docs/TESTING_JSON_SCHEMA.md).
